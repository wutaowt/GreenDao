...
/**
 * DAO for table "CATEGROY".
*/
public class CategroyDao extends AbstractDao<Categroy, Long> {
//    CategroyDao categroyDao = GreenDaoManager.getInstance().getSession().getCategroyDao();
//    Categroy categroy = new Categroy(null,"酒",1,"长城红酒",2,1,2,0,"吴涛");
//    public CategroyDao getCategroyDao() {
//        categroyDao.insert(categroy);
//        return categroyDao;
//
//    }

    public static final String TABLENAME = "CATEGROY";

    /**
     * Properties of entity Categroy.<br/>
    ...
    public CategroyDao(DaoConfig config) {
        super(config);
    }

    public CategroyDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CATEGROY\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CATEGROY\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Categroy entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Categroy entity) {
        stmt.clearBindings();
    ...
    @Override
    public Categroy readEntity(Cursor cursor, int offset) {
        Categroy entity = new Categroy( //
    ...
    @Override
    public void readEntity(Cursor cursor, Categroy entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Categroy entity, long rowId) {
        entity.setCat_id(rowId);
        return rowId;
    }

    @Override
    public Long getKey(Categroy entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(Categroy entity) {
